/*
  ...
  1. Tablas Principales
    ...
    - `factura_pacientes`: Relación entre facturas y pacientes (permite múltiples pacientes)
    - `factura_recetas`: Relación entre facturas y recetas (permite múltiples recetas)
...
CREATE FUNCTION actualizar_estado_factura()
RETURNS TRIGGER AS $$
BEGIN
